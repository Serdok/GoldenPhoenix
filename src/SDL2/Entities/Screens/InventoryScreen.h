...
private:
    ...
    const Vector2i coordinates[ ObjectID::TOTAL - 1 ] = {
            ...
            Vector2i( WIDTH/12 + offset/2.0f, 5.5f*offset ), Vector2i( 3*WIDTH/12 + offset/2.0f, 5.5f*offset ), Vector2i( 5*WIDTH/12 + offset/2.0f, 5.5f*offset ), Vector2i( 7*WIDTH/12 + offset/2.0f, 5.5f*offset ), Vector2i( 9*WIDTH/12 + offset/2.0f, 5.5f*offset ), Vector2i( 11*WIDTH/12 + offset/2.0f, 5.5f*offset )
