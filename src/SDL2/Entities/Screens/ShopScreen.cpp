...
: _castle( castle ), _translation(trans), Texture( "Marchand.png", true )
{
    ...
    _price_GrapplingHook = new Texture(std::to_string( _trader->getPrice(5) ), "Roboto-Regular.ttf", 25, { 255, 255, 255 } );
    ...
    _price_LifePotion = new Texture( std::to_string( _trader->getPrice(7) ), "Roboto-Regular.ttf", 25, { 255, 255, 255 } );
