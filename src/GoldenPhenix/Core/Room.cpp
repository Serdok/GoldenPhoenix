...
void Room::LoadJoiningData( std::queue< std::string >& data )
{
    ...
    for (int line = 0 ; line < 3 ; ++line)
    {
        ...
        hasTorch = ( doorInfo.length() == 11
                     || doorInfo.length() == 12
                     || ( doorInfo[ doorInfo.length() - 1 ] == 'T' || doorInfo[ doorInfo.length() - 1 ] == 'F' ));
...
std::queue< std::string > Room::Save() const
{
    ...
    for (int i = 0 ; i < ROOM_HEIGHT ; ++i)
    {
        ...
        for (int j = 0 ; j < ROOM_WIDTH ; ++j)
        {
            ...
            {
                case -7: line.append( "S" );
                    break;
                case -6: line.append( "H" );
                    oblivion = true;
                    origin = false;
                    break;
                case -5: line.append( "B" );
                    break;
                case -4: line.append( "Q" );
                    oblivion = true;
                    origin = true;
                    break;
                case -3: line.append( "O" );
                    break;
                case -2: line.append( "M" );
                    break;
                case -1: line.append( "W" );
                    break;
                case ObjectID::Nothing: line.append( "_" );
                    break;
                case ObjectID::Egg: line.append( "E" );
                    break;
                case ObjectID::IronKey: line.append( "I" );
                    break;
                case ObjectID::GoldKey: line.append( "G" );
                    break;
                case ObjectID::GrapplingHook: line.append( "H" );
                    break;
                case ObjectID::LifePotion: line.append( "L" );
                    break;
                case ObjectID::Hint1: line.append( "X" );
                    break;
